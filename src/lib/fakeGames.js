...
export async function generateFakeGamesAndReviews() {
  ...
  for (let i = 0; i < gamesToAdd; i++) {
    ...
    const gameData = {
      ...
      name: randomData.gameTitles[
        randomNumberBetween(0, randomData.gameTitles.length - 1)
      ],
      avgRating,
      developer: randomData.gameDevelopers[
        randomNumberBetween(0, randomData.gameDevelopers.length - 1)
      ],
      ...
      photo: `https://storage.googleapis.com/firestorequickstarts.appspot.com/game_${randomNumberBetween(
        1,
        22
      )}.png`,
